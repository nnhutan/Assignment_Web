...
function IntroPage() {
    return (
        ...
        <section className="testimonials text-center bg-light" style={{paddingTop:"7rem",paddingBottom:"7rem"}}>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            ...
                            <p className="font-weight-light mb-0">"Half-Frontend Director"</p>
                        </div>
                    </div>
                    <div className="col-lg-3">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
            ...
            <div className="container-fluid p-0">
                <div className="row g-0">
                    ...
                    <div className="col-lg-6 col-md-12 order-lg-1 my-auto showcase-text">
                        ...
                        <p className="lead mb-0">Nhân viên với sự chuyên nghiệp luôn hướng đến sự thoải mái của khách hàng</p>
                    </div>
                </div>
                <div className="row g-0">
                    ...
                    <div className="col-lg-6 my-auto showcase-text">
                        ...
                        <p className="lead mb-0">Với nhiều sản phẩm như laptop, tablet, smartphone,... cùng với nhiều mẫu thiết kế và màu sắc ấn tượng</p>
                    </div>
                </div>
                <div className="row g-0">
                    ...
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                        ...
                        <p className="lead mb-0">Sản phẩm luôn có mức giá hợp lý với từng đối tượng khách hàng</p>
                    </div>
                </div>
            </div>
        </section>
